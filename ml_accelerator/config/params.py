...
class Params:
    ...
    TARGET_FEATURE_QUANTILE_THRESHOLD: float
    FEATURE_FEATURE_CORREL_THRESHOLD: float
    CATEGORICAL_PERCENTAGE: float
    ...
    def load(cls) -> None:
        ...
        cls.TARGET_FEATURE_QUANTILE_THRESHOLD: float = FEATURE_SELECTION_PARAMS.get("TARGET_FEATURE_QUANTILE_THRESHOLD")
        cls.FEATURE_FEATURE_CORREL_THRESHOLD: float = FEATURE_SELECTION_PARAMS.get("FEATURE_FEATURE_CORREL_THRESHOLD")
        cls.CATEGORICAL_PERCENTAGE: float = FEATURE_SELECTION_PARAMS.get("CATEGORICAL_PERCENTAGE")
