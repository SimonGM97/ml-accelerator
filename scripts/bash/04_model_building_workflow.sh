...
TRAIN_PROD_MODEL=$(yq eval '.MODEL_BUILDING_PARAMS.TRAIN_PROD_MODEL' ${CONFIG_FILE})
TRAIN_STAGING_MODELS=$(yq eval '.MODEL_BUILDING_PARAMS.TRAIN_STAGING_MODELS' ${CONFIG_FILE})
TRAIN_DEV_MODELS=$(yq eval '.MODEL_BUILDING_PARAMS.TRAIN_DEV_MODELS' ${CONFIG_FILE})
...
echo "  - TRAIN_PROD_MODEL: ${TRAIN_PROD_MODEL}"
echo "  - TRAIN_STAGING_MODELS: ${TRAIN_STAGING_MODELS}"
echo "  - TRAIN_DEV_MODELS: ${TRAIN_DEV_MODELS}"
